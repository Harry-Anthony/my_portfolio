...
export function Contact() {
    const mailIcon = (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#ffaf23" className="w-6 h-6">
        ...
        <div id="contact" className="flex flex-col w-full items-center pb-[100px] bg-[#252735]">
            ...
            <div className="w-[500px] flex flex-col mt-[20px]">
                ...
                <div className="flex flex-col items-start w-full">
                    ...
                    <textarea name="Text1" className="h-[242px] bg-[#d4ddf3] w-full my-2 p-2 rounded"></textarea>
                </div>
                <div className={classNames(css(buttonStyle.button), "mt-[20px] self-end")}>
                    Submit
                </div>
...
function ContactForm(props: any) {
    return (
        <div className="flex flex-col items-start mb-5">
            ...
            <input type='text' className={classNames(props.width, props.height, "bg-[#d4ddf3] my-2 p-2 text-start rounded")} />
        </div>
    )
}