...
export function Header() {
    return (
        <div className="text-[#fff] bg-header pb-[200px] bg-cover">
            <img className="bg-img-header" src="https://images.unsplash.com/photo-1518655048521-f130df041f66?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2070&q=80" alt="" />
            <Popover>
                            ...
                            <div className="flex items-center justify-between px-5 pt-4">
                                ...
                                <div className="-mr-2">
                                    <Popover.Button className="inline-flex items-center justify-center rounded-md bg-[#252735] p-2 text-gray-400 hover:text-gray-500 focus:outline-none">
                                        ...
                                        <XMarkIcon className="bg-[#252735] h-6 w-6" aria-hidden="true" />
                                    </Popover.Button>
                                </div>
                            </div>
                            <div className="space-y-1 px-2 pt-2 pb-3">
                                <ul className="lg:flex">
                                    <li className={css(styles.li)}><a className="block rounded-md px-3 py-2 text-base font-medium hover:bg-gray-50 hover:text-gray-900 t-shadow" href='#about'><span className={css(styles.link_number)}>01. </span>About</a></li>
                                    ...
                                    <li className={css(styles.li)}><a className="block rounded-md px-3 py-2 text-base font-medium hover:bg-gray-50 hover:text-gray-900 t-shadow" href='#work'><span className={css(styles.link_number)}>02. </span>Work</a></li>
                                    <li className={css(styles.li)}><a className="block rounded-md px-3 py-2 text-base font-medium hover:bg-gray-50 hover:text-gray-900 t-shadow" href='#contact'><span className={css(styles.link_number)}>03. </span>Contact</a></li>
                                </ul>
                            </div>
                        </div>
                    </Popover.Panel>
            ...
            <motion.main initial={{opacity: 0}} animate={{opacity: 1}} transition={{type:'spring', duration: 2, bounce: 0.3}} className="mx-auto mt-10 max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                <div className="lg:text-left">
                    ...
                    <h1 className="text-4xl tracking-tight text-gray-900 sm:text-5xl md:text-6xl">
                        <span className="title block text-[#6c591f85] t-shadow">Harivola</span>
                        <span className="title block text-[#6c591f85] t-shadow">RANDRIAMIHAJA</span>
                    </h1>
                    <p className={css(textStyle.paragraph, styles.p)}>I am a mobile and web application developer.</p>
...
function ListGreyIcon() {
    return (
        <div className='circles'>
            {/**flutter */}
            <li><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="96px" height="96px"><polygon fill="grey" points="26,4 6,24 12,30 38,4" /><polygon fill="grey" points="38,22 27,33 21,27 26,22" /><rect width="8.485" height="8.485" x="16.757" y="28.757" fill="grey" transform="rotate(-45.001 21 33)" /><polygon fill="grey" points="38,44 26,44 21,39 27,33" /><polygon fill="grey" points="21,39 30,36 27,33" /></svg></li>
